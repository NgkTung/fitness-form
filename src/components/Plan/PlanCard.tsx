      ...
      <div className="bg-white border border-blue-100 rounded-2xl shadow-sm hover:shadow-md p-5 transition flex flex-col justify-between">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="mt-4 bg-blue-500 text-white text-sm font-medium py-2 px-4 rounded-xl hover:bg-blue-600 transition"
          >
            View Details
          </button>
          ...
          {save && (
            <button
              ...
              className={`mt-4 text-sm font-medium py-2 px-4 rounded-xl transition ${
